...
def weight_quantize(model, cfg, task_type):
    ...
    params_dir=os.path.join(os.path.dirname(table_file),"params.npz")
    np.savez(params_dir, **npz_file)
...
def main():
    ...
    params = {'obj': "../03_benchmark/02_task_specific_benchmarks/02_objdet/jaad_pdet_ssd_tf_graph.pb",
              'seg': "../03_benchmark/02_task_specific_benchmarks/01_semseg/mscoco_fcn_padded_lscape_prediction_tf_graph.pb",
              'act': "../03_benchmark/02_task_specific_benchmarks/03_actrec/conv_lstm_benchmark_tf_graph.pb",
              'seg3': "/home/liusongwei/seg_dot3.pb",
              'seg4': "/home/liusongwei/seg_dot4.pb",
              'obj3': "/home/liusongwei/obj_dot3.pb",
              'obj4': "/home/liusongwei/obj_dot4.pb",
              'act3': "/home/liusongwei/act_dot3.pb",
              'act4': "/home/liusongwei/act_dot4.pb"}
